...
import {
  Accordion
} from "./chunk-6BFMFJEW.js";
import {
  Spinner
} from "./chunk-2MFY2W42.js";
import {
  FormControl,
  NG_VALUE_ACCESSOR,
  ReactiveFormsModule,
...
var _c04 = ["demoCarousel"];
var _c1 = () => ["Progressive Rock", "Psychedelic"];
...
function StyleGuide_Conditional_29_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(4);
    \u0275\u0275property("badges", \u0275\u0275pureFunction0(31, _c1))("actions", ctx_r1.profileActions.slice(0, 2));
    \u0275\u0275advance(7);
...
function StyleGuide_Conditional_30_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(107, "div", 86)(108, "div", 87);
    \u0275\u0275element(109, "app-tabs", 201);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(110, "div", 14)(111, "h3");
    \u0275\u0275text(112, "Carrusel de \xC1lbumes");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(113, "app-carousel", 202);
    \u0275\u0275template(114, StyleGuide_Conditional_30_app_card_114_Template, 1, 2, "app-card", 203);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(115, "div", 14)(116, "h3");
    \u0275\u0275text(117, "Carrusel de Canciones");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(118, "app-carousel", 204);
    \u0275\u0275template(119, StyleGuide_Conditional_30_app_card_119_Template, 1, 2, "app-card", 205);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(127, ". ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(128, "div", 86)(129, "div", 87)(130, "app-carousel", 206, 0);
    \u0275\u0275template(132, StyleGuide_Conditional_30_app_card_132_Template, 1, 2, "app-card", 203);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(133, "div", 207)(134, "app-button", 208);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(136, "label", 209)(137, "span");
    \u0275\u0275text(138, "Opacidad:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(139, "input", 210);
...
function StyleGuide_Conditional_31_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "div", 146)(11, "div", 213)(12, "div", 214);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(13, "svg", 215);
    \u0275\u0275element(14, "rect", 216)(15, "line", 217);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(16, "span", 218);
    \u0275\u0275text(17, "app-header");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(18, "p", 219);
    \u0275\u0275text(19, "Cabecera con logo central, franjas 70s y botones de autenticaci\xF3n.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "div", 220)(21, "code");
    \u0275\u0275text(22, "--header-bg");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(23, "code");
    \u0275\u0275text(24, "$borde-brutal-thick");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(25, "div", 213)(26, "div", 214);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(27, "svg", 215);
    \u0275\u0275element(28, "line", 221)(29, "line", 222)(30, "line", 223);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(31, "span", 218);
    \u0275\u0275text(32, "main-nav");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(33, "p", 219);
    \u0275\u0275text(34, "Barra de navegaci\xF3n sticky con enlaces y toggle de tema.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(35, "div", 220)(36, "code");
    \u0275\u0275text(37, "--nav-bg");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "code");
    \u0275\u0275text(39, "$z-nav");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(40, "div", 213)(41, "div", 214);
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(42, "svg", 215);
    \u0275\u0275element(43, "rect", 216)(44, "line", 224);
    \u0275\u0275elementEnd();
    \u0275\u0275namespaceHTML();
    \u0275\u0275elementStart(45, "span", 218);
    \u0275\u0275text(46, "app-footer");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(47, "p", 219);
    \u0275\u0275text(48, "Pie de p\xE1gina sim\xE9trico con logo central y botones de navegaci\xF3n.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "div", 220)(50, "code");
    \u0275\u0275text(51, "--header-bg");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(62, "div", 225)(63, "div", 226);
    \u0275\u0275element(64, "app-card", 227);
    \u0275\u0275elementStart(65, "code", 228);
    \u0275\u0275text(66, "$breakpoint-mobile");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(67, "div", 226);
    \u0275\u0275element(68, "app-card", 229);
    \u0275\u0275elementStart(69, "code", 228);
    \u0275\u0275text(70, "$breakpoint-tablet");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(71, "div", 226);
    \u0275\u0275element(72, "app-card", 230);
    \u0275\u0275elementStart(73, "code", 228);
    \u0275\u0275text(74, "$breakpoint-desktop");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(75, "div", 226);
    \u0275\u0275element(76, "app-card", 231);
    \u0275\u0275elementStart(77, "code", 228);
    ...
    \u0275\u0275text(86, ". ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(87, "div", 232)(88, "div", 233)(89, "span", 234);
    \u0275\u0275text(90, "10");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(91, "span", 235);
    \u0275\u0275text(92, "$z-spinner");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(93, "span", 236);
    \u0275\u0275text(94, "Loading global");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(95, "div", 237)(96, "span", 234);
    \u0275\u0275text(97, "9");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(98, "span", 235);
    \u0275\u0275text(99, "$z-notification");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(100, "span", 236);
    \u0275\u0275text(101, "Toast notifications");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(102, "div", 238)(103, "span", 234);
    \u0275\u0275text(104, "8");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(105, "span", 235);
    \u0275\u0275text(106, "$z-tooltip");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(107, "span", 236);
    \u0275\u0275text(108, "Tooltips");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(109, "div", 239)(110, "span", 234);
    \u0275\u0275text(111, "7");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(112, "span", 235);
    \u0275\u0275text(113, "$z-popover");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(114, "span", 236);
    \u0275\u0275text(115, "Dropdowns, popovers");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(116, "div", 240)(117, "span", 234);
    \u0275\u0275text(118, "6");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(119, "span", 235);
    \u0275\u0275text(120, "$z-modal");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(121, "span", 236);
    \u0275\u0275text(122, "Modales");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(123, "div", 241)(124, "span", 234);
    \u0275\u0275text(125, "5");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(126, "span", 235);
    \u0275\u0275text(127, "$z-overlay");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(128, "span", 236);
    \u0275\u0275text(129, "Backdrops");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(130, "div", 242)(131, "span", 234);
    \u0275\u0275text(132, "4");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(133, "span", 235);
    \u0275\u0275text(134, "$z-nav");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(135, "span", 236);
    \u0275\u0275text(136, "Navegaci\xF3n principal");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(137, "div", 243)(138, "span", 234);
    \u0275\u0275text(139, "3");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(140, "span", 235);
    \u0275\u0275text(141, "$z-fixed");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(142, "span", 236);
    \u0275\u0275text(143, "Sidebar, alertas fijas");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(144, "div", 244)(145, "span", 234);
    \u0275\u0275text(146, "2");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(147, "span", 235);
    \u0275\u0275text(148, "$z-sticky");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(149, "span", 236);
    \u0275\u0275text(150, "Elementos sticky");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(151, "div", 245)(152, "span", 234);
    \u0275\u0275text(153, "1");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(154, "span", 235);
    \u0275\u0275text(155, "$z-dropdown");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(156, "span", 236);
    \u0275\u0275text(157, "Dropdowns simples");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(158, "div", 246)(159, "span", 234);
    \u0275\u0275text(160, "0");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(161, "span", 235);
    \u0275\u0275text(162, "$z-base");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(163, "span", 236);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(170, "div", 146)(171, "div", 247)(172, "span", 248);
    \u0275\u0275text(173, "--bg-primary");
    \u0275\u0275elementEnd();
    \u0275\u0275element(174, "div", 249);
    \u0275\u0275elementStart(175, "span", 250);
    \u0275\u0275text(176, "Fondo principal");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(177, "div", 247)(178, "span", 248);
    \u0275\u0275text(179, "--bg-secondary");
    \u0275\u0275elementEnd();
    \u0275\u0275element(180, "div", 251);
    \u0275\u0275elementStart(181, "span", 250);
    \u0275\u0275text(182, "Fondo secundario");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(183, "div", 247)(184, "span", 248);
    \u0275\u0275text(185, "--header-bg");
    \u0275\u0275elementEnd();
    \u0275\u0275element(186, "div", 252);
    \u0275\u0275elementStart(187, "span", 250);
    \u0275\u0275text(188, "Fondo del header");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(189, "div", 247)(190, "span", 248);
    \u0275\u0275text(191, "--nav-bg");
    \u0275\u0275elementEnd();
    \u0275\u0275element(192, "div", 253);
    \u0275\u0275elementStart(193, "span", 250);
    \u0275\u0275text(194, "Fondo de navegaci\xF3n");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(195, "div", 247)(196, "span", 248);
    \u0275\u0275text(197, "--color-primary");
    \u0275\u0275elementEnd();
    \u0275\u0275element(198, "div", 254);
    \u0275\u0275elementStart(199, "span", 250);
    \u0275\u0275text(200, "Color de acci\xF3n principal");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(201, "div", 247)(202, "span", 248);
    \u0275\u0275text(203, "--shadow-color");
    \u0275\u0275elementEnd();
    \u0275\u0275element(204, "div", 255);
    \u0275\u0275elementStart(205, "span", 250);
...
function StyleGuide_For_33_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "app-notification", 256);
...
var StyleGuide = class _StyleGuide {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StyleGuide, selectors: [["app-style-guide"]], viewQuery: function StyleGuide_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275repeaterCreate(32, StyleGuide_For_33_Template, 1, 7, "app-notification", 12, _forTrack0);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance();
...
\r
        <!-- Tabs (Original) -->\r
        <div class="showcase">\r
          <h3>Tabs (Pesta\xF1as)</h3>\r
          <p class="showcase__description">\r
            Navegaci\xF3n por teclado (flechas izquierda/derecha) y soporte para tabs deshabilitados.\r
          </p>\r
          <div class="showcase__column">\r
            <div class="showcase__item showcase__item--full">\r
              <app-tabs [tabs]="tabsExample" [initialActiveTab]="'overview'"></app-tabs>\r
            </div>\r
          </div>\r
        </div>\r
\r
...
\r
              <div class="style-guide__carousel-demo-controls">\r
                <app-button (clicked)="toggleCarouselHighlight()" variant="secondary" size="sm">\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StyleGuide, { className: "StyleGuide", filePath: "src/app/pages/style-guide/style-guide.ts", lineNumber: 60 });
})();
export {
  StyleGuide
};
//# sourceMappingURL=chunk-ZJOMMD7D.js.map
